...
public class CreatingOrganizationWithRatingTypeTestNGTest 
{
	@Test
	public void CreatingOrganizationWithRatingTypeTestNGTest()
	{
		...
		//test-script data
		String orgName = "Google_"+randomInt;
	...
	@Test
	public void CreatingOrganizationWithRatingTypeTestNGTest1()
	{
		Random random = new Random();
		int randomInt = random.nextInt(1000);
		//common data
